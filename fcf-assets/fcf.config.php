...
// EMAIL MESSAGE
// *************
define('EMAIL_TO', 'lawrencemutuku1152@gmail.com');
define('EMAIL_TO_NAME', 'lawrence');

define('EMAIL_TO_CC', 'lorenzondaya@gmail.com');
define('EMAIL_TO_CC_NAME', 'lorenzo');

define('EMAIL_TO_BCC', '');
define('EMAIL_TO_BCC_NAME', '');

define('EMAIL_FROM', 'lawrence.mutuku@luthuli.co.ke');
define('EMAIL_FROM_NAME', 'lawrence');
